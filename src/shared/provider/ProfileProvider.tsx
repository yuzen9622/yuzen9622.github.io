...
export function ProfileProvider({ children }: { children: ReactNode }) {
  ...
  const initialState: ProfileProviderState = {
    ...
    awards: [
      {
        id: "lung-hwa",
        title: t("awards.lung-hwa.title"),
        description: t("awards.lung-hwa.description"),
        time: "2025-06-09",
      },
      {
        id: "tqc-python",
        title: t("awards.tqc-python.title"),
        description: t("awards.tqc-python.description"),
        time: "2025-06-13",
      },
      {
        id: "apcs",
        title: t("awards.apcs.title"),
        description: t("awards.apcs.description"),
        time: "2025-06-14",
      },
      {
        id: "ytp",
        title: t("awards.ytp.title"),
        description: t("awards.ytp.description"),
        time: "2025-08-23",
      },
    ],
    techIcons: {
