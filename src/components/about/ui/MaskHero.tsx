    ...
    <>
      <div className=" relative  text-center  flex-1  flex flex-col items-center justify-center  ">
        ...
        <motion.div
          ...
          className="  absolute   flex flex-col items-center justify-center inset-0 text-center  cursor-default mask-[url('/mask.svg')] bg-primary mask-center  mask-no-repeat    text-primary-foreground mask-alpha "
        >
          <div>
            <motion.div
              initial={{ opacity: 0 }}
